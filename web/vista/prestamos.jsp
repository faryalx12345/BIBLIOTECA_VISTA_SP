    ...
    <body>
        ...
        <aside id="sidebar" class="sidebar">
            ...
            <ul class="sidebar-nav" id="sidebar-nav">
                ...
                <li class="nav-heading">Autor Adriana Godoy</li>
                <img src="assets/img/libro presta.jpg" alt=""/>
                                ...
                                <table id="example3" class="display table header-border table-hover verticle-middle" style="min-width: 845px">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-primary text-center">Estudiante</th>
                                            <th class="text-primary text-center">Carrera</th>
                                            <th class="text-primary text-center">Libro</th>
                                            <th class="text-primary text-center">Prestamo</th>
                                            <th class="text-primary text-center">Entrega</th>
                                            <th/>
                                        </tr>
                                    </thead>
                                    <tbody>
